...
if __name__ == "__main__":
    DATA_PATH = pathlib.PurePath('/MLAIM/AIMLab/Sheina/databases/VTdb/win_len/1/')
    results_dir = cts.RESULTS_DIR
    train_prediction_model(DATA_PATH, results_dir, model_type=2, dataset='win_len_1', method='')
