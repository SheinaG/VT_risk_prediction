...
class VFDB_Parser(BaseParser):

    def __init__(self, window_size=60, load_on_start=True):
        super(VFDB_Parser, self).__init__()
        ...
        self.raw_ecg_path = cts.DATA_DIR / "vfdb"
        self.orig_anns_path = cts.DATA_DIR / "vfdb"
