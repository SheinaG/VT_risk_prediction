...
def jqrs_detector(id, ecg_dir=cts.PARSING_PROJECT_DIR, n_windows=1, pool=None, fs=200, THRES=cts.SQI_WINDOW_THRESHOLD,
                  REF_PERIOD=0.52, DEB=False):
    """
