...
if __name__ == '__main__':
    ...
    features_per_window('rbdb', ids_tp + ids_sp, data_path, ML_path, pvc_path, vt_wins=1, win_len=30)
    features_per_window('rbdb', ids_tn + ids_sn + ids_vn, data_path, ML_path, pvc_path, vt_wins=0, win_len=30)
